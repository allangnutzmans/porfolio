...
<template>
  <div class="left-side flex flex-col gap-5 basis-[240px] border-r border-border p-[26px] overflow-auto shrink-0 max-[945px]:hidden [scrollbar-width:thin]">
    <div class="side-wrapper">
      <div class="side-title text-inactive mb-3.5">Apps</div>
      <div class="side-menu flex flex-col whitespace-nowrap">
        <NuxtLink 
          to="/"
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
          <svg viewBox="0 0 512 512" class="w-4 mr-2">
        ...
        <NuxtLink 
          ...
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
          <svg viewBox="0 0 488.932 488.932" fill="currentColor" class="w-4 mr-2">
            <path
          ...
          Updates
          <span class="notification-number updates relative ml-auto w-[18px] h-[18px] text-[11px]">3</span>
        </NuxtLink>
      </div>
    </div>
    <div class="side-wrapper">
      <div class="side-title text-inactive mb-3.5">Tech & Tools</div>
      <div class="side-menu flex flex-col whitespace-nowrap">
        <NuxtLink 
          v-for="tech in CATEGORIES" 
          :to="`/${tech.name.toLowerCase()}`"
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
            <v-icon :name="tech.icon" class="w-4 mr-2" />
          {{ tech.name }}
        </NuxtLink>
      </div>
    </div>
    <div class="side-wrapper">
      <div class="side-title text-inactive mb-3.5">Fonts</div>
      <div class="side-menu flex flex-col whitespace-nowrap">
        <a 
          href="#"
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
          <svg viewBox="0 0 332 332" fill="currentColor" class="w-4 mr-2">
            <path
    ...
    <div class="side-wrapper">
      <div class="side-title text-inactive mb-3.5">Contact Links</div>
      <div class="side-menu flex flex-col whitespace-nowrap">
        <a 
          href="#"
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
          <svg viewBox="0 0 512 512" fill="currentColor" class="w-4 mr-2">
            <path
        ...
        <a 
          ...
          class="flex items-center font-normal px-[10px] py-[10px] text-[14px] rounded-[6px] transition duration-300 mb-[5px] no-underline text-theme-color hover:bg-hover-menu [&.router-link-active]:bg-hover-menu"
        >
          <svg viewBox="0 0 511.441 511.441" fill="currentColor" class="w-4 mr-2">
            <path
